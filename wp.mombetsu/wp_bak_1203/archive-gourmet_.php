...
<main>
  ...
  <section>
    <div class="container">
      <div class="row p-3">
        <h2 class="mb-4"><span class="font-weight-bold line-c">紋別グルメ</span></h2>
        <p class="p-3">
    ...
    <div id="wrap">
      ...
      ?>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <h3 class="card-title"><?php $list_lead = SCF::get('list_lead'); echo esc_html($list_lead); ?></h3>
              <p class="card-text"><?php $list_text = SCF::get('list_text'); echo nl2br($list_text); ?></p>
              <a href="<?php the_permalink(); ?>" class="btn btn-warning">詳細を見る</a>
            </div>
          </div>
